...
class LineChart: UIView {
    ...
    let lineGap: CGFloat = UIScreen.main.bounds.width / 5
    ...
    private func setupView() {
        ...
        gradientLayer.colors = [#colorLiteral(red: 0.6779710054, green: 0.693159461, blue: 0.7269327044, alpha: 0.6962756849).cgColor, UIColor.clear.cgColor]
